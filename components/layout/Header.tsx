            ...
            >
              <motion.ul className="flex flex-col gap-4">
                {[
                  ...
                  >
                    <Link href={item.href} className="block text-gray-700 hover:text-primary transition-colors">
                      {item.label}
                    </Link>
                  </motion.li>
                ))}
                {user ? (
                  <>
                    ...
                    >
                      {user.role === 'admin' ? (
                        <Link href="/admin" className="block text-gray-700 hover:text-primary transition-colors">管理画面</Link>
                      ) : (
                        <Link href="/mypage" className="block text-gray-700 hover:text-primary transition-colors">マイページ</Link>
                      )}
                    </motion.li>
                    <motion.li
                      initial={{ x: -50, opacity: 0 }}
                  ...
                  <motion.li
                    ...
                    transition={{ delay: 0.35 }}
                  >
                    <Link href="/login" className="block text-gray-700 hover:text-primary transition-colors">会員登録/ログイン</Link>
                  </motion.li>
                )}
                <motion.li
                  initial={{ x: -50, opacity: 0 }}
                ...
                >
                  <Link href="/reservation" className="btn btn-primary block text-center">予約する</Link>
                </motion.li>
              </motion.ul>
            </motion.div>
          )}
