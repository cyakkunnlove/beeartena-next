...
import { CheckCircleIcon, ExclamationCircleIcon, InformationCircleIcon, XMarkIcon, XCircleIcon } from '@heroicons/react/24/outline';
...
const Toast: React.FC<ToastProps> = ({ toast, onClose }) => {
  ...
  const getStyles = () => {
    const baseStyles = 'flex items-start gap-3 w-full max-w-sm p-4 bg-white rounded-lg shadow-lg border';
    const typeStyles = {
