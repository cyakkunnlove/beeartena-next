          ...
          <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8">
            ...
            <div className="prose prose-gray max-w-none">
              ...
              <ol className="list-decimal pl-6 mb-4">
                ...
                <li className="mb-2">
                  予約のキャンセルは、予約日の3日前（72時間前）までに行うものとします。
                </li>
                <li className="mb-2">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4">第6条（禁止事項）</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4">第7条（施術に関する注意事項）</h2>
              <ol className="list-decimal pl-6 mb-4">
                <li className="mb-2">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4">第8条（個人情報の取り扱い）</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4">第10条（サービス内容の変更等）</h2>
              <p className="mb-4">
                当サロンは、会員への事前の通知なく、本サービスの内容を変更、追加または廃止することがあり、会員はこれを承諾するものとします。
              </p>

              <h2 className="text-2xl font-semibold mt-8 mb-4">第11条（利用規約の変更）</h2>
              <p className="mb-4">
                当サロンは、必要と判断した場合には、会員に通知することなく本規約を変更することができるものとします。
                変更後の利用規約は、当サロンウェブサイトに掲載された時点から効力を生じるものとします。
              </p>

              <h2 className="text-2xl font-semibold mt-8 mb-4">第12条（退会）</h2>
              <ol className="list-decimal pl-6 mb-4">
                <li className="mb-2">
                  会員は、当サロンの定める手続きにより、いつでも退会することができます。
                </li>
                <li className="mb-2">
                  退会と同時に会員資格は消滅し、会員向け機能の利用はできなくなります。
                </li>
              </ol>

              <h2 className="text-2xl font-semibold mt-8 mb-4">第13条（準拠法・管轄裁判所）</h2>
              <ol className="list-decimal pl-6 mb-4">
                <li className="mb-2">
